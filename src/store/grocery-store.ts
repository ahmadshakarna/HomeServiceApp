// عشان نستخدم zustand في تخزين حالة التطبيق، نقوم بإنشاء متجر (store) لإدارة عناصر البقالة. هذا المتجر يحتوي على حالة العناصر، حالة التحميل، وأي أخطاء قد تحدث أثناء العمليات. كما يوفر المتجر وظائف لتحميل العناصر، إضافة عنصر جديد، تحديث الكمية، تبديل حالة الشراء، إزالة عنصر، ومسح العناصر المشتراة.
